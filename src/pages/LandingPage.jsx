...
export default function LandingPage() {
  ...
  const pollutionSourcesData = {
    labels: ["Industrial", "Agricultural", "Domestic", "Other"],
    datasets: [
      {
        label: "Pollution Contribution (%)",
        data: [40, 30, 20, 10],
        backgroundColor: ["#2ba4e0", "#418fb6", "#435761", "#282f33"],
        borderColor: "#ffffff",
        borderWidth: 2,
      },
    ],
  ...
  const biodiversityData = {
    labels: ["Fish", "Birds", "Plants", "Invertebrates"],
    datasets: [
      {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        {/* Nueva sección: Data Insights */}
        <section className="w-full py-20 md:py-32 bg-white">
          <div id="data" className="container mx-auto px-4 md:px-6 max-w-7xl">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              <Badge className="bg-[#418fb6]/20 text-[#418fb6] hover:bg-[#418fb6]/30 border-none">
                Data Insights
              </Badge>
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-[#435761] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Explora visualizaciones interactivas basadas en datos
                  recopilados de la cuenca del Río Motagua
                </p>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mx-auto">
              <Card className="border-[#418fb6]/20 shadow-md hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  <CardTitle className="text-[#282f33]">
                    Calidad del Agua
                  </CardTitle>
                  <CardDescription className="text-[#435761]">
                    Índice de calidad del agua a lo largo de los años
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="h-[250px]">
                    <Line data={waterQualityData} options={chartOptions} />
                  </div>
                </CardContent>
                <CardFooter>
                  <Button
                    variant="ghost"
                    className="text-[#418fb6] hover:text-[#2ba4e0] hover:bg-[#418fb6]/10"
                    asChild
                  >
                    <Link to="/data">
              ...
              <Card className="border-[#418fb6]/20 shadow-md hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  ...
                  <CardDescription className="text-[#435761]">
                    Distribución de las principales fuentes de contaminación
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="h-[250px]">
                    <Bar data={pollutionSourcesData} options={chartOptions} />
                  </div>
                </CardContent>
                <CardFooter>
                  <Button
              ...
              <Card className="border-[#418fb6]/20 shadow-md hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  ...
                  <CardDescription className="text-[#435761]">
                    Distribución de especies en el ecosistema
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="h-[250px]">
                    <Doughnut data={biodiversityData} options={chartOptions} />
                  </div>
                </CardContent>
                <CardFooter>
                  <Button
